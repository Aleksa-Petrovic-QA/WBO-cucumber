...
class StraightLines {
	...
	@When("User changes pen opacity")
	def decreaceOpacity() {
		WebUI.callTestCase(findTestCase('WBO/Actions/Decreace opacity'), [:], FailureHandling.STOP_ON_FAILURE)
	}

	@When("Draws a straight line")
